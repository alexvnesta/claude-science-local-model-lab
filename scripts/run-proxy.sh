...
export PROXY_HARNESS_TOOL_ALLOWLIST="${PROXY_HARNESS_TOOL_ALLOWLIST:-}"
export PROXY_HARNESS_FORCE_SUBMIT_AFTER_TOOL_RESULTS="${PROXY_HARNESS_FORCE_SUBMIT_AFTER_TOOL_RESULTS:-0}"
...
exec python3 "$ROOT/proxy/anthropic_mtplx_proxy.py" \
  ...
  --harness-tool-allowlist "$PROXY_HARNESS_TOOL_ALLOWLIST" \
  --harness-force-submit-after-tool-results "$PROXY_HARNESS_FORCE_SUBMIT_AFTER_TOOL_RESULTS" \
